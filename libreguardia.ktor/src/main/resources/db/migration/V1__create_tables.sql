...
CREATE TABLE absence (
	id UUID PRIMARY KEY,
	date DATE NOT NULL,
	schedule_id UUID NOT NULL REFERENCES schedule(id) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE service_tbl (
	...
	user_id UUID DEFAULT NULL REFERENCES user_tbl(id) ON DELETE RESTRICT ON UPDATE RESTRICT
);