...
class PlaceTypeService(
    ...
    suspend fun getAll(): List<PlaceTypeModel> = withTransaction { placeTypeRepository.getAll() }
    ...
    suspend fun delete(uuid: UUID) {
        withTransaction {
            if (!placeTypeRepository.deleteThis(uuid)) throw PlaceTypeNotFoundException()
        }
    }
}